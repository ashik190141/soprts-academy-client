    ...
    const onSubmit = data => {
        ...
        createUser(data.email, data.password)
            ...
            const saveUser = {name: data.name, email: data.email}
                ...
                fetch('https://astha-sports-academy-server.vercel.app/users', {
                    method: 'POST',
                    headers: {
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" name="name" {...register("name",{ required: true })}
                                placeholder="Name" className="input input-bordered w-64" />
                        ...
                        <div className="form-control">
                            ...
                            <input type="text" name="photoUrl" {...register("photoUrl",{ required: true })}
                                placeholder="Photo Url" className="input input-bordered w-64" />
                        ...
                        <div className="form-control">
                            <label className="label">
                                ...
                                <input type="password" name="confirmPassword" {...register("confirmPassword", {required:true})}
                                    placeholder="Confirm Password" className="input input-bordered w-64" />
                                {errors.confirmPassword && <span className="text-red-600">Confirm Password is required</span>}
                        </div>

                        <div className='form-control mt-6'>
                            <input className="btn btn-primary uppercase w-64" type="submit" value="Sign Up" />
                        </div>

                    </form>
                    <p className="text-center mb-5"><small>Already Have an Account? </small><br />
                       <Link to="/login" className="uppercase text-orange-600">Go to Login</Link>
                    </p>
