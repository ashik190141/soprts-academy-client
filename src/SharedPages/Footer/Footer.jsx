...
import websiteImg from '../../assets/sports_academy.jpg';
        ...
        <div className='bg-black mt-28'>
            <div className='flex items-center justify-center pt-10'>
                <div className="flex md:flex-row gap-5 items-center">
                    ...
                    <p className="font-bold text-3xl md:text-5xl text-white">Astha <span className="font-bold text-orange-500">Sports Academy</span></p>
                </div>
            </div>
