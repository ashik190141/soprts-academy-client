...
var Reveal = (props) => {
  ...
  const animationStyles = (0, import_react17.useMemo)(
    () => getAnimationCss({
  ...
  return jsx2(Fragment2, { children: import_react17.Children.map(children, (node, index) => {
    if (!(0, import_react17.isValidElement)(node))
      return null;
...
var AttentionSeeker = (props) => {
  ...
  const [keyframes87, animationCss3] = (0, import_react2.useMemo)(() => getStyles(effect), [effect]);
  return jsx2(
    Reveal,
    {
      keyframes: keyframes87,
...
var Bounce = (props) => {
  ...
  const keyframes87 = (0, import_react32.useMemo)(
...
var Fade = (props) => {
  ...
  const keyframes87 = (0, import_react43.useMemo)(
...
var Flip = (props) => {
  ...
  const keyframes87 = (0, import_react57.useMemo)(
...
var Roll = (props) => {
  ...
  const keyframes87 = (0, import_react67.useMemo)(() => getStyles5(reverse), [reverse]);
  return jsx2(Reveal, { keyframes: keyframes87, ...rest });
};
...
var Rotate = (props) => {
  const { direction, reverse = false, style, ...rest } = props;
  const [keyframes87, animationCss3] = (0, import_react68.useMemo)(
...
var Slide = (props) => {
  const { direction, reverse = false, ...rest } = props;
  const keyframes87 = (0, import_react79.useMemo)(
...
var Zoom = (props) => {
  const { direction, reverse = false, ...rest } = props;
  const keyframes87 = (0, import_react88.useMemo)(
